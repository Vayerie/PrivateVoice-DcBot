...
module.exports = (client, message, args, cmd, prefix) => {
  if (cmd === "setup") {
    ...
    if (channel) {
      message.reply({
        embeds: [new Discord.MessageEmbed()
          ...
          .setColor(ee.color)
          .setDescription(`<:Voice:932252642728636427> **Join To Create Setup One Was Completed**\n\nNew Join To Create Channel: ${channel}`)
    ...
    if (channel) {
      message.reply({
        embeds: [new Discord.MessageEmbed()
          //.setTitle("<778404076466602024> Setup 2 Complete for Join To Create")
          .setColor(ee.color)
          .setDescription(`<:Voice:932252642728636427> **Join To Create Setup Two Was Completed**\n\nNew Join To Create Channel: ${channel}`)
          .setFooter(ee.footertext, ee.footericon)
        ]
      });
    ...
    message.reply({
      embeds: [new Discord.MessageEmbed()
        //.setTitle("<778404076466602024> Successfully changed the Channelname for the temp. Channels")
        .setColor(ee.color)
        .setDescription(`<:Voice:932252642728636427> **Default Private Voice Channel Name Was Changed**\n\nNew Private Voice Channel Name: \`${client.settings2.get(message.guild.id, "channelname")}\`\n\nPreview Of The New Private Voice Channel Name: \`${client.settings2.get(message.guild.id, "channelname").replace("{user}", message.author.username)}\``)
        .setFooter(ee.footertext, ee.footericon)
      ]
    });
    return;
    ...
    if (channel) {
      message.reply({
        embeds: [new Discord.MessageEmbed()
          //.setTitle("<778404076466602024> Setup 3 Complete for Join To Create")
          .setColor(ee.color)
          .setDescription(`<:Voice:932252642728636427> **Join To Create Setup Three Was Completed**\n\nNew Join To Create Channel: ${channel}`)
          .setFooter(ee.footertext, ee.footericon)
        ]
      });
    ...
    message.reply({
      embeds: [new Discord.MessageEmbed()
        .setColor(ee.color)
        .setDescription(`<:Voice:932252642728636427> **Default Private Voice Channel Name Was Changed**\n\nNew Private Voice Channel Name: \`${client.settings3.get(message.guild.id, "channelname")}\`\n\nPreview Of The New Private Voice Channel Name: \`${client.settings3.get(message.guild.id, "channelname").replace("{user}", message.author.username)}\``)
        .setFooter(ee.footertext, ee.footericon)
      ]
    });
    return;

    ...
    case "general": {
      return message.reply({
        embeds: [new Discord.MessageEmbed()
          ...
          //.setURL("https://youtu.be/zNE8insVgOA")
          .setDescription(`<:One:946041613220716564> **Commands For General**\n\n**Prefix**: \`${prefix}\` | [Click here - Support Server](https://discord.gg/4eR3BjQjt4)`)
    ...
    case "setup":
      {
        return message.reply({
          embeds: [new Discord.MessageEmbed()
            ...
            //.setURL("https://youtu.be/zNE8insVgOA")
            .setDescription(`<:Two:946041613052956753> **Commands For Setup**\n\n**Prefix**: \`${prefix}\` | [Click here - Support Server](https://discord.gg/4eR3BjQjt4)`)
            .addField(`\`${prefix}Setup\` -> Follow steps`, "> *Creates The First Kind Of Join To Create Channel\n Default Private Voice Channel Name: \`Private {user}\`*")
            ...
            .addField("\u200b", "\u200b")
            .addField(`\`${prefix}Setup2\` -> Follow steps`, "> *Creates The Second Kind Of Join To Create Channel\n Default Private Voice Channel Name: \`{user}' Channel\`*")
            .addField(`\`${prefix}Setname2 <ChannelName>\``, "> *Changes The Default Private Voice Channel Name For Setup 2* \n**Note:** *Having \`{user}\` In Your Channel Name Will Be Replaced By The User's Username*\n" + `Example: \`${prefix}setname2 {user}'s VC\``)
            .addField("\u200b", "\u200b")
            .addField(`\`${prefix}Setup3\` -> Follow steps`, "> *Creates The Third Kind Of Join To Create Channel\n Default Private Voice Channel Name: \`{user}' Lounge\`*")
            .addField(`\`${prefix}Setname3 <ChannelName>\``, "> *Changes The Default Private Voice Channel Name For Setup 3* \n**Note:** *Having \`{user}\` In Your Channel Name Will Be Replaced By The User's Username*\n" + `Example: \`${prefix}setname3 {user}'s VC\``)
            .setFooter(ee.footertext, ee.footericon)
          ]
        })
      };
    ...
    case "voice": {
      return message.reply({
        embeds: [new Discord.MessageEmbed()
          ...
          //.setURL("https://youtu.be/zNE8insVgOA")
          .setDescription(`<:Three:946041613258473502> **Commands For Voice**\n\n**Prefix**: \`${prefix}\` | [Click here - Support Server](https://discord.gg/4eR3BjQjt4)`)
    ...
    default:
      return message.reply({
        embeds: [new Discord.MessageEmbed()
          ...
          .addField(`<:One:946041613220716564> <:Info:931908144626532403>**${prefix}Help General**`, "> *Shows All General/Information Commands!*", true)
          .addField(`<:Two:946041613052956753> **${prefix}Help Setup**`, "> *Shows All Setup Voice System Commands!*", true)
          .addField(`<:Three:946041613258473502> **${prefix}Help Voice**`, "> *Shows All Voice Moderation Commands!*", true)
        ]
      });
